...
add_dependency 'merb-gen', '=1.0.1', :require => 'merb-gen'
add_dependency 'merb-param-protection', '=1.0.1', :require => 'merb-param-protection'
add_dependency 'merb-haml', '=1.0.1', :require => 'merb-haml'
...
add_dependency 'merb-cache', '=1.0.1', :require => 'merb-cache'
add_dependency 'merb-helpers', '=1.0.1', :require => 'merb-helpers'
add_dependency 'merb-assets', '=1.0.1', :require => 'merb-assets'
add_dependency 'merb-slices', '=1.0.1', :require => 'merb-slices'
add_dependency 'merb-action-args', '=1.0.1', :require => 'merb-action-args'
